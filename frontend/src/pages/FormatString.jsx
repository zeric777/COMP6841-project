...
import { formatSolutions } from "../data/challengeSolutions";
    ...
    <>
      ...
      {accepted && challenge.id < challenges.length && (
        <div className="solution-actions">
          <Link className="button" to={`/format/${challenge.id + 1}`}>Unlock FS-{challenge.id + 1}</Link>
        </div>
      )}
    </>
  );
